        ...
        <section class="row">
            <section class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="apresentacao">
                    <p class="descApresentacao">Olá, meu nome é Israel Barbosa, tenho vinte e um anos, sou estudante do
                        quinto período do curso Sistemas de Internet da faculdade São Miguel.
                    </p>
                    <p class="descApresentacao">Estou em busca de uma oportunidade como estagiário desenvolvedor
                        Front-end; quero trabalhar com vocês da Audax, para aprofundar meus conhecimentos e adquirir
                        novas experiências.</p>
